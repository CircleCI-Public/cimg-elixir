...
docker build --file 1.16/24.3.4/Dockerfile -t cimg/elixir:1.16.3-erlang-24.3.4 -t cimg/elixir:1.16-erlang-24.3.4 --platform linux/amd64 --push .
docker build --file 1.16/24.3.4/node/Dockerfile -t cimg/elixir:1.16.3-erlang-24.3.4-node -t cimg/elixir:1.16-erlang-24.3.4-node --platform linux/amd64 --push .
docker build --file 1.16/24.3.4/browsers/Dockerfile -t cimg/elixir:1.16.3-erlang-24.3.4-browsers -t cimg/elixir:1.16-erlang-24.3.4-browsers --platform linux/amd64 --push .
