...
docker build --file 1.19/25.3.2/Dockerfile -t cimg/elixir:1.19.1-erlang-25.3.2 -t cimg/elixir:1.19-erlang-25.3.2 --platform linux/amd64 --push .
docker build --file 1.19/25.3.2/node/Dockerfile -t cimg/elixir:1.19.1-erlang-25.3.2-node -t cimg/elixir:1.19-erlang-25.3.2-node --platform linux/amd64 --push .
docker build --file 1.19/25.3.2/browsers/Dockerfile -t cimg/elixir:1.19.1-erlang-25.3.2-browsers -t cimg/elixir:1.19-erlang-25.3.2-browsers --platform linux/amd64 --push .
